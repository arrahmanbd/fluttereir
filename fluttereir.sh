#!/bin/bash
#================================#
#   FlutterEIR by @arrahman      #
#   https://arrahmanbd.github.io #
#================================#

# Banner
printf "\e[1;34m
 _______  _                                 _______  _____  ______  
(_______)| |        _    _                 (_______)(_____)(_____ \ 
 _____   | | _   _ | |_ | |_   ____   ____  _____      _    _____) )
|  ___)  | || | | ||  _)|  _) / _  ) / ___)|  ___)    | |  (_____ ( 
| |      | || |_| || |__| |__( (/ / | |    | |_____  _| |_       | |
|_|      |_| \____| \___)\___)\____)|_|    |_______)(_____)      |_|
                                                                    
\e[1;32m  ---------------- by @AR Rahman --------------\n\e[1;0m"
# Function to display help text
function show_help() {
  echo "Usage: ./fluttereir.sh "
...
function intro() {
printf "\n\e[1;33mUsage: \e[1;35m./fluttereir.sh \e[1;35m[OPTION] \n\n"
...
printf "\e[1;35mAndroid SDK: \e[1;34mhttps://drive.google.com/file/d/1TrZ-1zASMZbWvpSiNIxXFn57myeTbcah/view\n\n";
}
...
echo
# Display Flutter text and additional information
echo -e "\e[1mFlutter Easy InstalleR\e[0m"
echo "Install Flutter Easily on Any Linux (Debian, Arch)"
intro
echo -e "\e[1m==============================================\e[0m"
